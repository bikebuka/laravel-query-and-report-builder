...
namespace JumaMiller\MadiLib\ReportGenerator\ReportMedia;
use Closure;
use Illuminate\Support\Facades\App;
use JumaMiller\MadiLib\ReportGenerator\ReportGenerator;
                                ...
                                foreach ($columns as $columnName) {
                                    ...
                                    if (array_key_exists($columnName, $this->showTotalColumns)) {
                                        if ($this->showTotalColumns[$columnName] == 'point') {
                                            ...
                                            $totalRows->push(strtoupper($this->showTotalColumns[$columnName]) . ' ExcelReport.php' . number_format($this->total[$columnName],
                                                    2, '.', ','));
                                        }
                                    } else {
                                        $totalRows->push(null);
